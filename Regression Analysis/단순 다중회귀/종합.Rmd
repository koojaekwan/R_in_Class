...
표준화 회귀계수단 ㄷ위를 배제시켜 회귀계수의 상대적 중요성을 알 수 있다.  
...
정확한 모형의 p-value는 F통계량을 이용하여 구할 수 있다. 정확한 값은 `r pf(summary(model)$fstatistic[1], summary(model)$fstatistic[2], summary(model)$fstatistic[3], lower.tail=F)`이다.  
